    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="p-4 bg-white shadow-md rounded-lg">
          <h2 className="text-lg font-semibold text-gray-700">Doanh thu hôm nay</h2>
        ...
        <div className="p-4 bg-white shadow-md rounded-lg">
          <h2 className="text-lg font-semibold text-gray-700">Sản phẩm bán chạy</h2>
        ...
        <div className="p-4 bg-white shadow-md rounded-lg">
          <h2 className="text-lg font-semibold text-gray-700">Đơn hàng đang xử lý</h2>
      ...
      <div className="mt-8 bg-white shadow-md rounded-lg p-6">
        <h2 className="text-lg font-semibold text-gray-700">Biểu đồ doanh thu</h2>
        <p className="text-sm text-gray-500 mt-2">
          **Ghi chú**: Đây là nơi bạn có thể tích hợp biểu đồ doanh thu bằng thư viện như `Chart.js` hoặc `Recharts`.
        </p>
      </div>
    </div>
  );
